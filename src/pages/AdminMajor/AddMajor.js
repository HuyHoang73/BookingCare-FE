...
import { Button, Flex, Form, Image, Input, Space, Upload } from "antd";
  ...
  const formAddMajor = (
    <>
      ...
      >
        ...
        <Form.Item label="Tên chuyên khoa" name="name" rules={[
                {
                  required: true,
        ...
        <Form.Item label="Mô tả ngắn" name="shortDescription" rules={[
                {
                  required: true,
